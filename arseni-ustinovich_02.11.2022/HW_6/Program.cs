...
namespace HW_5
{
    public class Person
    {
        ...
        {
            Console.WriteLine("This is just a Person");
        }
    }
    public class Student : Person
    {
        ...
        public Student(string name, string surname, int age, string gender, int course, string department, string grants) : base(name, surname, age, gender)
        {
            Course = course;
            Department = department;
            Grants = grants;
        }
        public Student() : this("Unknown", "Unknown", -1, "Unknown", -1, "Unknown", "Unknown") { }
        public override void PrintWhoIsIt()
        {
            Console.WriteLine("This is Person and Studet");
        }
    }
    public class Employee : Person
    {
        ...
        public Employee(string name, string surname, int age, string gender, double monthSalary, int exp, string company, string job) : base(name, surname, age, gender)
        {
        ...
        public Employee() : this("Unknown", "Unknown", -1, "Unknown", -1, -1, "Unknown", "Unknown") { }
        public override void PrintWhoIsIt()
        {
            Console.WriteLine("This is Person and Employee");
        }
    }
    internal class Program
    {
        ...
        {
            PersonInfo(student);
            Console.WriteLine($"{student.Name} is getting {student.Department} degree on a {student.Grants} basis. Current course is {student.StringCourse}.");
        }
        static void EmployeeInfo(Employee employee)
        {
            PersonInfo(employee);
            Console.WriteLine($"{employee.Name} is {employee.Job} working in {employee.Company} Working experience is {employee.StringExp}. Month salary is {employee.StringMonthSalary:f2}$.");
        }
        static void WageInc(Employee employee, int num)
        {
            employee.MonthSalary *= (1 + num / 100.0);
        }
        ...
        static void Main(string[] args)
        {
            ...
            Person[] myList = { myPerson, myStudent, myEmployee };

            foreach (Person myHuman in myList)
            {
                myHuman.PrintWhoIsIt();
            }
